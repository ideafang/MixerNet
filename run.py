...
args.add_argument('-dim', '--dim', default=128, type=int, help='bw and tr embedding dimensions')
...
args.add_argument('-s', '--max_steps', default=1000000, type=int, help='max running steps')
